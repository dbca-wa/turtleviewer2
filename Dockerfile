...
RUN Rscript -e 'remotes::install_version("RODBC",upgrade="never", version = "1.3-19")'
...
RUN Rscript -e 'remotes::install_version("etlTurtleNesting",upgrade="never", version = "0.5.1")'
RUN Rscript -e 'remotes::install_version("wastdr",upgrade="never", version = "0.8.2")'
RUN Rscript -e 'remotes::install_github("r-spatial/sf@d31ff41135ba2bd93d2aeb1c9e9bef5ffdbd0ecb")'
RUN Rscript -e 'remotes::install_github("Thinkr-open/golem@ffd91a697951a6ae9cfa1bbbbae4c62ee35eca59")'
